...
import { initTestimonialsMarquee } from "../../animations";
...
const Testimonial = () => {
  ...
  useEffect(() => {
    if (testimonials.length > 0) {
      const cleanup = initTestimonialsMarquee(containerRef.current, trackRef.current);
      return cleanup;
    }
  }, [testimonials]);
  ...
  return (
    <section
      id="testimonials"
      ref={containerRef}
      className="relative py-24 sm:py-32 overflow-hidden bg-slate-50/70"
    >
      ...
      {/* GSAP INFINITE HORIZONTAL MARQUEE (RIGHT TO LEFT) */}
      <div className="relative w-full overflow-hidden py-4 group">
        ...
        <div ref={trackRef} className="flex gap-6 sm:gap-8 px-4 will-change-transform">
